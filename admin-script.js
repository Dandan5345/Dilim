...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (flightDealForm) {
        flightDealForm.addEventListener('submit', async e => {
            ...
            const data = {
                ...
                imageUrl:          document.getElementById('flight-image-url').value,
                flightDetails: {
    ...
    function resetPackageForm() {
        ...
        packageHotelsContainer.innerHTML = '';
        packageHotelFieldCount = 0;
        packageTripTypesContainer.querySelectorAll('input').forEach(cb => cb.checked = false);
    ...
    function resetHotelForm() {
        ...
        hotelTripTypesContainer.querySelectorAll('input').forEach(cb => cb.checked = false);
